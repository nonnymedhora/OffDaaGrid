...
// ---------------------------------------------------------------------
public class DoesSourceAnswerExistRowImpl extends ViewRowImpl implements DoesSourceAnswerExistRow {
    ...
    public static final int SRARAVID = 6;
    public static final int SRACOLOR = 7;
    public static final int SRACOMMENT = 8;
    public static final int SRAEXCLUDEYN = 9;
    public static final int SRAWEIGHTMULTIPLIER = 10;

    /**This is the default constructor (do not remove)
     */
    public DoesSourceAnswerExistRowImpl() {
    }
