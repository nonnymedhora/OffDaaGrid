...
// ---------------------------------------------------------------------
public class ReportLockInfoRowImpl extends ViewRowImpl implements ReportLockInfoRow {
    ...
    /**Gets the attribute value for OTL_STATUS using the alias name OtlStatus
     */
    public String getOtlStatus() {
        return (String) getAttributeInternal(OTLSTATUS);
    }

    /**Sets <code>value</code> as attribute value for OTL_STATUS using the alias name OtlStatus
     */
