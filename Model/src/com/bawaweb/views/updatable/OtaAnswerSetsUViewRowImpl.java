...
// ---------------------------------------------------------------------
public class OtlAnswerSetsUViewRowImpl extends ViewRowImpl implements OtlAnswerSetsUViewRow {
    ...
    public static final int BaWaWEBANSWERSETVALUESUVIEW = 6;
    public static final int BaWaWEBREPORTANSWERSETSUVIEW = 7;

    /**This is the default constructor (do not remove)
     */
    public OtlAnswerSetsUViewRowImpl() {
    }
    ...
    protected Object getAttrInvokeAccessor(int index, 
        ...
        case BaWaWEBANSWERSETVALUESUVIEW:
            return getOtlAnswerSetValuesUView();
    ...
    /**Gets the associated <code>RowIterator</code> using master-detail link OtlAnswerSetValuesUView
     */
    public RowIterator getOtlAnswerSetValuesUView() {
        return (RowIterator)getAttributeInternal(BaWaWEBANSWERSETVALUESUVIEW);
    }
