...
public class TallySingleListIndustryAnsSet implements TallySingleListIndustryAnsSetInfo {
 ...
 */
    ...
    private int         tally;  // count(sra_rav_id)



    public TallySingleListIndustryAnsSet() {
    }
