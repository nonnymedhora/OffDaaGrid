...
class SnoopServlet extends HttpServlet {
	...
	Enumeration enumaration = getServletConfig().getInitParameterNames();
        if (enumaration != null) {
            boolean first = true;
		...
		String param = (String) enumaration.nextElement();
	...
	if (e.hasMoreElements()) {
        ...
        print(out, "Java Classpath", System.getProperty("java.class.path","."));
        

        out.println( "<BR/><HR/><BR/>");
        
        print(out, "System Library Classpath", System.getProperty("java.library.path", "."));
        out.println( "<BR/><HR/><BR/>");
        ...
        for ( Iterator it = keySet.iterator(); it.hasNext(); ) {
            ...
            String thevalue = p.getProperty( thekey );
            
            print(out, thekey, thevalue);
